...
public:
    ...
    // void loadGraph (int, int, vector <>, vector <> );
    // void DFS (vector, int );
    // void BFS (vector, int );
...
// template <class V, class E>
// void Graph<V,E>::loadGraph(int n, int m, vector <>, vector <>)
// {
//     /* Buscar vertex origen */
//     auto node = find(nodes.begin(), nodes.end(), source);
...
// template <class V, class E>
// void Graph<V,E>::DFS(vector M, int N)
// {

// }

// template <class V, class E>
// void Graph<V,E>::BFS(vector M, int N)
// {
